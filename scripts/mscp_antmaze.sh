...
if [ ${env_name} = "antmaze-umaze-v2" ]; then
    warmup_steps=700
elif [ ${env_name} = "antmaze-umaze-diverse-v2" ]; then
    warmup_steps=700
elif [ ${env_name} = "antmaze-medium-play-v2" ]; then
    warmup_steps=700
elif [ ${env_name} = "antmaze-medium-diverse-v2" ]; then
    warmup_steps=700
elif [ ${env_name} = "antmaze-large-play-v2" ]; then
    warmup_steps=700
elif [ ${env_name} = "antmaze-large-diverse-v2" ]; then
    warmup_steps=700
elif [ ${env_name} = "antmaze-ultra-play-v0" ]; then
    warmup_steps=2000
elif [ ${env_name} = "antmaze-ultra-diverse-v0" ]; then
    warmup_steps=2000
fi
...
do
    ...
    --auto_find_checkpoint --wandb_mode offline \
